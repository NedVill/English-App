const config = {
  ...
  sadImage: 'img/failure.png',
  succesImage: 'img/success.png',
  succesSound: 'audio/correct.mp3',
  errorSound: 'audio/error.mp3',
  looseSound: 'audio/failure.mp3',
...
const categories = ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Fruits', 'Vegetables'];
